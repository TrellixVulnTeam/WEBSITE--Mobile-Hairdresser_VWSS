...
$to = 'tadas.civilka@yahoo.co.uk'; // Add your email address inbetween the 'info@web-knack.com' replacing yourname@yourdomain.com - This is where the form will send a message to.
